...
2. **Run verification**: Call `labs_query` with a critique-focused prompt asking Perplexity to evaluate: logical errors, missing edge cases, file path accuracy, dependency ordering, scope creep, feasibility
